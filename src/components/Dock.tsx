...
import { ArrowUpRight, Camera, CircleUserRound, GitBranch, Github, Hammer, House, MapPin } from "lucide-react";
...
export default function Dock() {
  ...
  return (
    <div className="lg:fixed block bottom-0 left-0 right-0 px-10 md:py-6 pointer-events-none"> {/*bg-opacity-50 bg-gradient-to-b from-[#00000000] to-black*/}
